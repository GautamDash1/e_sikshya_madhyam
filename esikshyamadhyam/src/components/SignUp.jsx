       ...
       <div className=''>
          ...
          <form className='flex flex-col items-center' action="" onSubmit={RegisterUser}>
            <div className='w-full relative'>
              <input className='border border-gray-200 w-full rounded-full py-2 my-2 px-4 bg-transparent' name='username' placeholder='User Name' type="text" value={user.username || ""}  onChange={handleChange}/>
              <FaUser className='absolute top-[35%] right-3'/> 
            </div> 
            <div className='w-full relative'> 
              <input className='border border-gray-200 w-full rounded-full py-2 my-2 px-4 bg-transparent' name='email' placeholder='Email' type="email" value={user.email || ""} onChange={handleChange}/>
              <MdMail className='absolute top-[35%] right-3'/> 
            </div> 
            <div className='w-full relative'> 
              <input className='border border-gray-200 w-full rounded-full py-2 my-2 px-4 bg-transparent' name='password' placeholder='Enter Password' type="password" value={user.password || ""} onChange={handleChange}/>
