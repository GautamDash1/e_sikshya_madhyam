...
const Navbar = () => {
  ...
  color: #D7366F; 
      ...
      <div className='navbar-container z-10 text-gray-500 flex justify-between items-center w-full h-24 px-4 text-l'>
      <h1 className='text-3xl font-bold dark-pink ml-4 w-full text-center md:text-left'> E-Sikshya Madhyam</h1>
    ...
    <ul className='p-8 text-2xl'>
      ...
      <div className="main-content">
        <div className="container">
          ...
          >
            <div>
            <img src={require('./pic1.jpg')} alt="Slide 1" />
              <p className="legend">Interactive Courses: Engaging and comprehensive content to make learning enjoyable.</p>
            </div>
            <div>
            <img src={require('./pic2.jpg')} alt="Slide 2" />

              <p className="legend">Expert Instructors: Learn from the best in the field with real-world experience.</p>
            </div>
            <div>
            <img src={require('./pic3.jpg')} alt="Slide 3" />
              <p className="legend">Flexible Learning: Access your courses anytime, anywhere, at your own pace.</p>
            </div>
          </Carousel>
          <h2>Why Choose e-Shiksha?</h2>
          <p><strong>Community Support:</strong> Join a community of learners and share your journey.</p>
